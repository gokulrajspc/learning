package com.learning.twilio.service;

import com.learning.twilio.config.TwilioConfig;
import com.learning.twilio.dto.OtpStatus;
import com.learning.twilio.dto.PasswordResetRequestDto;
import com.learning.twilio.dto.PasswordResetResponseDto;
...
public class TwilioOTPService {
    ...
    public Mono<String> validateOTP(String UserOTP, String username) {
        ...
        if (UserOTP.equals(otpMap.get(username))) {
